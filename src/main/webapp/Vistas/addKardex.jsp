                            ...
                            <form onsubmit="return validarFormulario()" action="../SvKardex" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control mb-3" name="idProducto" placeholder="codigo del Producto" required>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control mb-3" id="tipoMovimiento" name="tipoMovimiento" placeholder="Tipo de Movimiento ()" required>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control mb-3" id="cantidad" name="cantidad" placeholder="Cantidad de Productos Movimiento" required>

                                    </div>
                                    <div class="col">
                                        <label>Tipo de Moneda: </label>
                                        <input type="text" class="form-control mb-3" name="idTipoMoneda" placeholder="Tipo de Moneda (PEN)" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control mb-3" id="existencias" name="existencias" placeholder="Cantidad de Productos en inventario" required>
