    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (produ != null) {
            if (tipo != null) {
                ...
                response.sendRedirect("Vistas/editIngresoProducto.jsp?error=tipoMonedaNoExiste");
            }

        } else {
            response.sendRedirect("Vistas/editIngresoProducto.jsp?error=productoNoExiste");
        }
