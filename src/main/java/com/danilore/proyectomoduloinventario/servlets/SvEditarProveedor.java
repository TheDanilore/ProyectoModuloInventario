...
public class SvEditarProveedor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String id_editar = request.getParameter("id_proveedorEdit");
        
        Proveedor proveedor = control.getProveedor(id_editar);
        
        proveedor = control.getProveedor(id_editar);
        
        HttpSession misesion = request.getSession();
        misesion.setAttribute("editarProveedor",proveedor);
        
        response.sendRedirect("Vistas/editProveedor.jsp");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        control.editProveedor(proveedor);
