 ...
 * @author Danilore
 */
@WebServlet(name = "SvEliminarCategoriaProducto", urlPatterns = {"/SvEliminarCategoriaProducto"})
public class SvEliminarCategoriaProducto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int id_eliminar = Integer.parseInt(request.getParameter("id_categoria"));
        control.deleteCategoriaProducto(id_eliminar);
