...
@Entity
public class GuiaRemisionSalida implements Serializable {
    @Id
    ...
    public GuiaRemisionSalida() {
        
        fecha_salida = LocalDateTime.now();
    }

    public GuiaRemisionSalida(String id, long ruc, String razon_social, String proveedor_direccion, String id_producto, long cantidad, String nombre_personal_recepciona, LocalDateTime fecha_salida) {
        this.id = id;
        this.ruc = ruc;
