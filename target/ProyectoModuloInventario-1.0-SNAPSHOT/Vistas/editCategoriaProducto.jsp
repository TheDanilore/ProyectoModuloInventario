<%-- 
    Document   : editCategoriaProducto
    Created on : 10 dic. 2023, 13:59:11
    Author     : Danilore
--%>
...
<%@include file="../components/menu.jsp" %>
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="container ">
                            <% CategoriaProducto categoriaObj = (CategoriaProducto) request.getSession().getAttribute("editarCategoria");%>
                            <center>
                                <font style="color: black;" align="center">
                                <h1>Registrar Categoria de Productos</h1>
                                </font>

                                <form action="../SvEditarCategoriaProducto" method="POST">
                                    <br>
                                    <div class="col">
